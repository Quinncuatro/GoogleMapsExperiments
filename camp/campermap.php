...
<head>
	...
	//<![CDATA[
		...
		var infoWindow = new google.maps.InfoWindow;
				...
				var html = "<b>" + name + "</b><br/>" + address + "<br/>" + city + "<br/>" + state;
...
<div class="container">
        <div class="row">
				...
				<br/>
				<a class="btn btn-default" href="index.php">Heat Map</a><a class="btn btn-default" href="../distance/index.php">Distance Map</a>
			</div>
