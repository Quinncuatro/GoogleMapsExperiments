...
<head>
	...
	//<![CDATA[
		...
		distance_in_miles = (distance / 1609.344);
				...
				var point_distance = markers[i].getAttribute("distance");
				if (point_distance < distance_in_miles) {
					...
					var html = "<b>" + name + "</b><br/>" + address + "<br/>" + city + "<br/>" + state + "<br/>" + point_distance + " Miles";
...
<div class="container">
        <div class="row">
				...
				<a class="btn btn-default" href="registration.php">Add A Camper</a><a class="btn btn-default" href="../camp/index.php">Camper Plot Map</a>
			</div>
